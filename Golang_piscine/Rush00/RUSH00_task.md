...
While working on this task, you can temporarily forget about gRPC and test the code by just sending it a sequence of values via stdin.
...
Turn in files: **\*.go**, **go.mod**, **go.sum**, **\*.proto**
